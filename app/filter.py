...
def replace_keywords_format(value):
    ...
    replace_rules = [
        ...
        ('Rules:', '<strong style="font: 1.1em \'빛의 계승자 Bold\';">Rules :</strong>'),
        ('Setup:', '<strong style="font: 1.1em \'빛의 계승자 Bold\';">SETUP :</strong>'),
        ('Unleash:', '<strong style="font: 1.1em \'빛의 계승자 Bold\';">Unleash :</strong>'),
